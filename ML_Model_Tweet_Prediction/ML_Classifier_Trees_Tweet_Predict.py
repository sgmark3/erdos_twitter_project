...
class_report_random, accuracy_random, vec_random = random_forest(tweetframe, 30)
class_report_adaboost, accuracy_adaboost, vec_adaboost = adaboost_decision_tree(tweetframe, 30)
...
a1 = len(tweetframe.public_metrics_retweet_count.loc[tweetframe['like_count'] < 30])
a2 = len(tweetframe.public_metrics_retweet_count)
