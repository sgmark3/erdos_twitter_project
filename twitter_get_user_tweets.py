...
import json
import twitter
from config import twitter_daq as tkey 
...
if __name__ == "__main__":
    api = twitter.Api(
        tkey.CONSUMER_KEY, tkey.CONSUMER_SECRET, tkey.ACCESS_TOKEN_KEY, tkey.ACCESS_TOKEN_SECRET
    )
    screen_name = "nytimesbusiness"
    print(screen_name)
    timeline = get_tweets(api=api, screen_name=screen_name)

    with open(screen_name+'_timeline.json', 'w+') as f:
